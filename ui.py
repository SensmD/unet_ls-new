...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        # 加载模型参数
        net.load_state_dict(torch.load('best_model_skin1.pth', map_location=device))  # todo 模型位置
        # 测试模式
        net.eval()
        self.model = net
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        self.left_img.setPixmap(QPixmap("images/UI/left.jpg"))
        ...
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/UI/gxufe.jpg'))
    ...
    ***上传图片***
    ...
    def upload_img(self):
        ...
        if fileName:
            ...
            # todo 上传图片之后右侧的图片重置，
            self.right_img.setPixmap(QPixmap("images/UI/logo.png"))
